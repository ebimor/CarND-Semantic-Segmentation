...
def build_file_list(images_root, labels_root, sample_name):
    image_sample_root = images_root + '/' + sample_name+'/images'
    image_root_len = len(image_sample_root)
    label_sample_root = labels_root + '/' + sample_name+'/labels'
...
def load_data(data_folder):
    images_root = data_folder +'/CityScapes'#+ '/leftImg8bit'
    labels_root = data_folder + '/CityScapes'#'/gtFine'

    print("-------------------looking for files in: "+images_root)
